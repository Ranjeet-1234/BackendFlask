...
account_config = {
    "ranveer": {
        "BASE_API_URL": "Your_secret_token",
        "LANGFLOW_ID": "Your_secret_token",
        "FLOW_ID": "Your_secret_token",
        "APPLICATION_TOKEN": "Your_secret_token",
    }
}

# API URLs and Key
API_URL_PLANET = "Your_secret_token"
API_URL_GEM = "Your_secret_token"
API_KEY = "Your_secret_token"

# Astra DB Connection
client = DataAPIClient("Your_secret_token")
database = client.get_database("Your_secret_token")
collection = database.get_collection("Your_secret_token")  # Using single collection
...
def index():
    if request.method == "POST":
        ...
        gem_response = requests.get(API_URL_GEM, pgit remote add origin https://github.com/Ranjeet-1234/BackendFlask.gitarams=gem_params)
